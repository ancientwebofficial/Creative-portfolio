    ...
    <section className="section-shell bg-[#0f141b]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 max-w-3xl">
          <span className="section-kicker mb-5">{content?.eyebrow || "Services"}</span>
          <h2 className="section-title text-4xl sm:text-5xl lg:text-6xl">
            {content?.heading || "Specialized Creative Services"}
          </h2>
          <p className="section-copy mt-5 text-lg">
            {content?.description || "Tailored design solutions for Minecraft creators, streamers, and content studios."}
          </p>
        </div>
              ...
              >
                <div className="relative z-10 flex flex-1 flex-col">
                  ...
                  <p className="mt-4 flex-1 text-sm leading-7 text-[#9aa7b9]">
                    {description || (category.id === "thumbnails"
