    ...
    <section id="pricing" className="section-shell bg-[#0c1118]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 max-w-3xl">
          <span className="section-kicker mb-5">Pricing</span>
          <h2 className="section-title text-4xl sm:text-5xl lg:text-6xl">
            Simple, Transparent Pricing
          </h2>
          <p className="section-copy mt-5 text-lg">
            Flexible rates for custom Minecraft creative work. Each project tailored to your needs.
          </p>
        </div>
              ...
              <div className="relative z-10 flex h-full flex-col">
                ...
                <div className="mb-8 border-b border-white/10 pb-8">
                  <div className="flex items-end gap-2">
                    ...
                    <span className="pb-1 text-sm text-[#9aa7b9]">/ project</span>
                  </div>
                </div>
        ...
        <div className="mt-12 flex flex-col gap-6 rounded-[2rem] border border-white/10 bg-white/5 p-8 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-lg font-semibold text-white">Need a custom package?</p>
            <p className="mt-1 text-xs uppercase tracking-[0.22em] text-[#9aa7b9]">
              {settings?.owner_name ? `Work directly with ${settings.owner_name}` : "Direct owner contact"}
            </p>
            <p className="mt-2 max-w-2xl text-sm leading-7 text-[#9aa7b9]">
              Bulk rates and specialized projects available. Let&apos;s discuss your needs.
            </p>
          </div>
